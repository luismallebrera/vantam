...
/**
 * Plugin Name: Elementor Integration Extended
 * Plugin URI: https://github.com/luismallebrera/vantam
 * Description: Extend the Elementor plugin with enhanced widgets and customizations. Works with any WordPress theme.
 * Version: 1.0.5
 * Author: Luis Mallebrera
 * Text Domain: elementor-integration-extended
...
if ( ! class_exists( 'VamtamElementorIntregration' ) ) {
	// Theme validation removed - plugin now works with any theme
	...
	class VamtamElementorIntregration {
		...
		public static function after_theme_setup() {
			...
			// Enable widget modifications by default (no theme dependency)
			// Define constants for styles if not already defined
			...
			add_action( 'elementor/init', function() {
				// Theme Site Settings - check if user disabled modifications
